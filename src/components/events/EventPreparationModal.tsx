      ...
      <div className="w-full sm:max-w-xl max-h-[90dvh] bg-[var(--color-surface-base)] border border-[var(--color-border-strong)] rounded-t-xl sm:rounded-[var(--radius-card)] shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          {activeTab === 'checklist' && (
            <div className="space-y-3">
              <p className="text-xs text-[var(--color-text-secondary)]">
                Complete these steps before the event to maximise your preparation and make a strong impression.
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 bg-amber-950/30 border border-amber-600/20 rounded-[var(--radius-sm)]">
                <p className="text-[11px] text-amber-300">
                  <strong>Tip:</strong> Practise this out loud 3 times before the event. Adjust the specifics based on which employer you are speaking with.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'questions' && (
            <div className="space-y-4">
              <p className="text-xs text-[var(--color-text-secondary)]">
                Thoughtful questions signal genuine interest. Here are tailored questions for each participating organisation.
              </p>
        ...
        <div className="p-4 border-t border-[var(--color-border-default)] flex items-center justify-between gap-3 shrink-0 bg-[var(--color-surface-sunken)]">
          <p className="text-[10px] text-[var(--color-text-tertiary)]">
            AI preparation generated by CareerOS. Personalised content unlocks when connected to your Career Twin.
          </p>
          <button
            type="button"
            onClick={onClose}
