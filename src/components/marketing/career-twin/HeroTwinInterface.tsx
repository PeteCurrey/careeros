  ...
  return (
    <div className="w-full p-6 sm:p-8 bg-white/90 backdrop-blur-md border border-[var(--color-border-default)] rounded-[var(--radius-card)] shadow-editorial space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-7 relative p-6 bg-[var(--color-ivory-base)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] min-h-[300px] flex flex-col justify-center items-center overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-2 mb-6">
            <div className="w-16 h-16 rounded-full bg-[var(--color-charcoal-deep)] text-[var(--color-ivory-base)] flex items-center justify-center shadow-md border-2 border-[var(--color-ivory-base)]">
              <User className="w-8 h-8" />
            </div>
            <div>
              <h4 className="font-serif font-bold text-sm text-[var(--color-charcoal-deep)]">Alex Morgan</h4>
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-[var(--radius-card)] text-xs font-mono transition-all border ${
                    isActive
                      ? 'bg-[var(--color-charcoal-deep)] text-[var(--color-ivory-base)] border-[var(--color-charcoal-deep)] shadow-xs'
