    ...
    <div className="space-y-6">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-[var(--radius-card)] text-xs font-semibold whitespace-nowrap transition-all border ${
                isActive
                  ...
                  : 'bg-[var(--color-surface-raised)] text-[var(--color-text-secondary)] border-[var(--color-border-default)] hover:border-[var(--color-charcoal-base)] hover:text-[var(--color-charcoal-deep)]'
              }`}
            >
              <Icon className={`w-3.5 h-3.5 ${isActive ? 'text-[var(--color-ivory-base)]' : 'text-[var(--color-taupe-600)]'}`} />
      ...
      <div className="p-8 bg-[var(--color-surface-raised)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] space-y-6 shadow-subtle">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-stretch">
          ...
          <div className="p-5 bg-[var(--color-ivory-base)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] space-y-2 md:col-span-2">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[var(--color-taupe-700)] block">
              2. TRANSFERABLE CAPABILITIES (IN CAREER TWIN)
            </span>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-[var(--color-charcoal-deep)] pt-1">
          ...
          <div className="p-5 bg-[var(--color-charcoal-deep)] text-[var(--color-ivory-base)] rounded-[var(--radius-card)] space-y-2">
        ...
        <div className="p-5 bg-[var(--color-surface-warm)] border border-[var(--color-border-subtle)] rounded-[var(--radius-card)] space-y-2 text-xs">
          ...
          <p className="text-[var(--color-charcoal-deep)] font-semibold font-mono text-[11px]">
