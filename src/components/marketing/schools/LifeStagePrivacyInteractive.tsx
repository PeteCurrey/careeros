...
const STAGES: LifeStage[] = [
  {
    ...
    guardianRelationship: 'School acts as in loco parentis under COPPA / UK GDPR Article 8 exceptions where authorised.',
  ...
  },
  {
    ...
    schoolRelationship: 'Enrolled in school workspace with career counsellor access.',
  ...
  },
  {
    id: '16-17',
    label: 'Ages 16–17',
    ageBand: 'Upper Secondary / Sixth Form (Ages 16–17)',
  ...
  },
  {
    ...
    ferpaStatus: 'FERPA rights transfer to student immediately upon postsecondary enrolment.',
