              ...
              <div className="p-4 bg-[var(--color-surface-warm)] border border-[var(--color-border-subtle)] rounded-[var(--radius-sm)] flex items-center justify-between gap-3 text-xs">
                <div className="space-y-0.5">
                  ...
                  <span className="text-white font-medium">
                    Requested 1:1 conversation with Ms. Alvarez (Counsellor)
                  </span>
                </div>
          ...
          {(activeTab === 'split' || activeTab === 'educator') && (
            <div className={cn('p-6 sm:p-7 space-y-6', activeTab === 'split' ? 'lg:col-span-6' : 'lg:col-span-12')}>
              ...
              <div className="p-4 bg-[var(--color-surface-base)] border border-[var(--color-border-default)] rounded-[var(--radius-sm)] space-y-3">
                ...
                <div className="pt-2 border-t border-[var(--color-border-subtle)] flex items-center justify-between text-xs pl-8">
                  ...
                  <button className="text-xs font-semibold text-white hover:text-[#6BB8FF] transition-colors flex items-center gap-1">
                    Open Counsellor Brief <ArrowRight className="w-3 h-3" />
                  </button>
                </div>
              </div>
              ...
              <div className="text-[11px] text-[var(--color-text-tertiary)] italic flex items-center gap-1.5">
                ...
                <span>Educator view displays permissioned workflow context — no behavioural profiling or employability scoring.</span>
              </div>
            </div>
          )}
