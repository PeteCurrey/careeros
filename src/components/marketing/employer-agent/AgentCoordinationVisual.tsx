        ...
        <div className="lg:col-span-5 p-6 rounded-[var(--radius-card)] bg-[var(--color-surface-base)] border border-[var(--color-border-default)] space-y-4 flex flex-col justify-between">
          <div className="space-y-3">
            <div className="flex items-center justify-between pb-2 border-b border-[var(--color-border-default)]">
              <span className="text-xs font-mono uppercase text-[#2F8FFF] font-bold flex items-center gap-1.5">
                <User className="w-3.5 h-3.5" /> Individual Side
              </span>
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[rgba(47,143,255,0.07)] text-[#6BB8FF] border border-[rgba(47,143,255,0.18)]">
                Opportunity Agent
              </span>
            </div>
          ...
          <div className="pt-3 border-t border-[var(--color-border-subtle)] text-[10px] font-mono text-[#6BB8FF] flex items-center gap-1.5">
            <Lock className="w-3 h-3" /> Private until user approves introduction
          </div>
        </div>

        {/* Middle Column: Mutual Alignment Channel */}
        <div className="lg:col-span-2 flex flex-col items-center justify-center gap-3 p-4 rounded-[var(--radius-card)] bg-[rgba(47,143,255,0.04)] border border-[rgba(47,143,255,0.18)] text-center">
          <div className="w-10 h-10 rounded-full bg-[rgba(47,143,255,0.07)] flex items-center justify-center text-[#2F8FFF]">
