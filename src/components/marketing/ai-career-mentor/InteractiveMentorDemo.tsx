      ...
      <div className="container-editorial space-y-12">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <h2
            ...
            className="text-display-section font-serif font-normal text-[var(--color-charcoal-deep)] tracking-tight"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch min-h-[720px]">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between bg-[var(--color-surface-raised)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] overflow-hidden shadow-subtle">
            ...
            <div className="relative w-full aspect-4/3 sm:aspect-16/11 lg:aspect-4/3 overflow-hidden bg-[var(--color-surface-warm)] border-b border-[var(--color-border-default)]">
              ...
              <div
                aria-hidden="true"
                className="absolute inset-0 bg-gradient-to-t from-[var(--color-charcoal-deep)]/80 via-transparent to-transparent pointer-events-none"
              />
            ...
            <div className="flex items-center justify-between border-b border-[var(--color-border-default)] pb-4 text-xs font-mono text-[var(--color-text-tertiary)]">
              <div className="flex items-center gap-3">
                <span
                  className={
                    stage === 1
                      ? 'text-[var(--color-charcoal-deep)] font-bold'
              ...
              {stage > 1 && (
                <button
                  type="button"
                  onClick={handleReset}
                  className="inline-flex items-center gap-1.5 text-xs font-mono font-semibold text-[var(--color-taupe-700)] hover:text-[var(--color-charcoal-deep)] transition-colors focus-visible:outline-2 focus-visible:outline-[var(--color-charcoal-deep)] rounded px-1.5 py-0.5"
                >
              ...
              {stage === 1 && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-display-section font-serif font-normal text-[var(--color-charcoal-deep)]">
                  ...
                  <div className="space-y-3 pt-2" role="group" aria-label="Career goal options">
                    {MENTOR_DEMO_BRANCHES.map((branch) => (
                      <button
                        ...
                        className="w-full text-left p-5 sm:p-6 bg-[var(--color-ivory-base)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] hover:border-[var(--color-charcoal-deep)] hover:bg-[var(--color-surface-warm)] transition-all group flex items-center justify-between gap-4 focus-visible:outline-2 focus-visible:outline-[var(--color-charcoal-deep)] shadow-xs"
                      >
                        <div className="space-y-1">
                          <span className="font-mono text-[11px] font-bold text-[var(--color-taupe-700)] uppercase tracking-wider block">
                            {branch.title}
                          </span>
                          <p className="font-serif font-medium text-base sm:text-lg text-[var(--color-charcoal-deep)] group-hover:translate-x-0.5 transition-transform">
                            {branch.subtitle}
                          </p>
                        </div>
                        <ArrowRight className="w-5 h-5 text-[var(--color-taupe-600)] group-hover:text-[var(--color-charcoal-deep)] group-hover:translate-x-1 transition-all shrink-0" />
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-xs font-mono text-[var(--color-taupe-700)] hover:text-[var(--color-charcoal-deep)] transition-colors"
                    >
                      <ArrowLeft className="w-3.5 h-3.5" />
                      <span>Change goal</span>
                    </button>
                    <span className="text-xs text-[var(--color-text-tertiary)]">&bull;</span>
                    <span className="font-mono text-xs font-bold text-[var(--color-charcoal-deep)] uppercase">
                  ...
                  <div className="space-y-3 pt-2" role="group" aria-label="Context options">
                    {selectedBranch.stage2Options.map((opt) => (
                      <button
                        ...
                        className="w-full text-left p-4 sm:p-5 bg-[var(--color-ivory-base)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] hover:border-[var(--color-charcoal-deep)] hover:bg-[var(--color-surface-warm)] transition-all group flex items-center justify-between gap-4 focus-visible:outline-2 focus-visible:outline-[var(--color-charcoal-deep)] shadow-xs"
                      >
                        <p className="font-serif font-medium text-base text-[var(--color-charcoal-deep)] group-hover:translate-x-0.5 transition-transform">
                          {opt.text}
                        </p>
                        <ArrowRight className="w-4 h-4 text-[var(--color-taupe-600)] group-hover:text-[var(--color-charcoal-deep)] group-hover:translate-x-1 transition-all shrink-0" />
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between border-b border-[var(--color-border-subtle)] pb-3">
                    <div className="flex flex-wrap items-center gap-2 text-xs font-mono text-[var(--color-taupe-700)]">
                      ...
                      <span>&bull;</span>
                      <span className="text-[var(--color-charcoal-deep)] font-semibold">
                        {selectedOption.text}
                      </span>
                    </div>
                  ...
                  <div className="p-5 bg-[var(--color-ivory-base)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] space-y-2">
                    ...
                    <p className="text-sm font-serif text-[var(--color-charcoal-deep)] leading-relaxed">
                      &ldquo;{selectedOption.response.hearing}&rdquo;
                    </p>
                  </div>

                  {/* 2. Possible Next Move */}
                  <div className="p-5 bg-[var(--color-surface-warm)] border-2 border-[var(--color-charcoal-deep)] rounded-[var(--radius-card)] space-y-2 shadow-xs">
                    <span className="font-mono text-[10px] font-bold uppercase tracking-wider text-[var(--color-charcoal-deep)] flex items-center gap-1.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-2 border-t border-[var(--color-border-subtle)]">
                      {selectedOption.response.factors.map((factor, fIdx) => (
                        <div key={fIdx} className="p-2.5 bg-white/70 rounded border border-[var(--color-border-subtle)] space-y-1">
                          ...
                          <p className="text-[11px] text-[var(--color-charcoal-deep)] leading-tight">
                            {factor.value}
                          </p>
                        </div>
                      ))}
                  ...
                  <div className="p-5 bg-[var(--color-ivory-base)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] space-y-3">
                    ...
                    <div className="pt-3 border-t border-[var(--color-border-subtle)] space-y-2">
                      <p className="text-xs font-semibold text-[var(--color-charcoal-deep)] font-serif">
                      ...
                      <div className="flex flex-wrap gap-4 text-xs font-mono font-bold">
                        <Link
                          ...
                          className="text-[var(--color-charcoal-deep)] hover:text-[var(--color-taupe-700)] underline underline-offset-4"
                        >
              ...
              {stage === 3 ? (
                <>
                  <button
                    type="button"
                    onClick={handleReset}
                    className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-[var(--radius-card)] border border-[var(--color-border-default)] bg-[var(--color-ivory-base)] text-xs font-mono font-bold text-[var(--color-charcoal-deep)] hover:bg-[var(--color-surface-warm)] transition-colors"
                  >
                    <RotateCcw className="w-3.5 h-3.5" />
