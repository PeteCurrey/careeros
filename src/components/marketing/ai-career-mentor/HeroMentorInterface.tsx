      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-start gap-4 pb-5 border-b border-[var(--color-border-subtle)]">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="font-bold text-sm text-[var(--color-text-primary)] font-serif">
                System-Assigned AI Mentor
              </span>
              <span className="px-1.5 py-0.5 rounded bg-white/10 text-[var(--color-taupe-300)] text-[10px] font-mono font-semibold">
                SYSTEM AI
              </span>
            </div>
        ...
        <div className="p-5 bg-[var(--color-surface-base)] border border-[var(--color-border-default)] rounded-[var(--radius-card)] space-y-4">
          ...
          <div className="pt-2 flex items-center justify-between text-xs border-t border-[var(--color-border-subtle)]">
            ...
            <div className="flex items-center gap-2">
              <button className="px-3 py-1.5 rounded bg-white/15 text-[var(--color-text-primary)] font-semibold text-xs hover:opacity-90 transition-opacity">
