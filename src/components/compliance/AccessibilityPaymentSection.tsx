    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div id="accessibility" className="p-6 rounded-md bg-[var(--color-surface-raised)] border border-[var(--color-border-default)] flex flex-col justify-between space-y-6">
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-secondary)] mt-2 leading-relaxed">
              Career exploration must be accessible to all students and job seekers regardless of ability. CareerOS is engineered to conform with <span className="text-white font-medium">WCAG 2.2 Level AA</span> and Section 508 standards.
            </p>
          </div>
        ...
        <div className="pt-3 border-t border-[var(--color-border-subtle)]">
          <Link href={ROUTES.TRUST_ACCESSIBILITY} className="inline-flex items-center gap-1.5 text-xs text-[#6BB8FF] hover:underline font-medium">
