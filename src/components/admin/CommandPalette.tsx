...
const SEARCH_OPTIONS: SearchOption[] = [
  ...
  { title: 'Event Organisers', category: 'Events', href: ROUTES.ADMIN_EVENTS_ORGANISERS, icon: Calendar },
  ...
  { title: 'Organisations Directory', category: 'Organisations', href: ROUTES.ADMIN_ORGANISATIONS, icon: Building2 },
  ...
  { title: 'Revenue Centre', category: 'Revenue', href: ROUTES.ADMIN_REVENUE, icon: LayoutDashboard },
