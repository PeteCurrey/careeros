...
export const MENTOR_REGISTRY: Record<string, MentorPersona> = {
  'marcus-thorne': {
    ...
    roleTitle: 'Systems Architecture & Engineering Leadership Specialization',
    ...
    relatedResources: [
      ...
      { label: 'Tech Industry Labor Intelligence', href: '/resources/careers' },
    ],
  },
  'amara-osei': {
    ...
    roleTitle: 'Clinical Specialization & Healthcare Leadership Specialization',
    portraitSrc: '/media/mentors/mentor_amara.jpg',
    ...
    specialistAreas: [
      'Clinical Credentialing & Specialty Milestones',
  ...
  'callum-reid': {
    ...
    roleTitle: 'Master Craft, Trade Licensing & Contracting Specialization',
    portraitSrc: '/media/mentors/mentor_callum.jpg',
  ...
  'priya-chakraborty': {
    ...
    roleTitle: 'Corporate Strategy, M&A & Executive Management Specialization',
    portraitSrc: '/media/mentors/mentor_priya.jpg',
  ...
  'isabelle-fontaine': {
    ...
    roleTitle: 'Regulatory Compliance, Legal Operations & Public Sector Specialization',
    portraitSrc: '/media/mentors/mentor_isabelle.jpg',
  ...
  'jordan-park': {
    ...
    roleTitle: 'Brand Strategy, Creative Direction & Media Systems Specialization',
    portraitSrc: '/media/mentors/mentor_jordan.jpg',
  ...
  'darnell-hayes': {
    ...
    roleTitle: 'Veteran Transition, Emergency Management & Operations Specialization',
    portraitSrc: '/media/mentors/mentor_darnell.jpg',
  ...
  'rosa-mbeki': {
    ...
    roleTitle: 'Venture Building, Commercialization & Small Enterprise Specialization',
    portraitSrc: '/media/mentors/mentor_rosa.jpg',
