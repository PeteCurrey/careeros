...
export const metadata: Metadata = {
  title: "Apprenticeships — Pathways | Career OS",
  description: "Career OS Pathways apprenticeships. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
