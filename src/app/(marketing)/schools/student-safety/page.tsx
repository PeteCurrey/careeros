...
export const metadata: Metadata = {
  title: "Student Safety — Schools | Career OS",
  description: "Career OS Schools student Safety. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
