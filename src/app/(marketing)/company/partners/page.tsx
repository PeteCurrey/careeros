...
export const metadata: Metadata = {
  title: "Partners — Company | Career OS",
  description: "Career OS Company partners. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
    canonical: "https://career-os.com/company/partners",
  },
};
