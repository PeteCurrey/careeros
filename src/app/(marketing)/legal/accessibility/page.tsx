...
export const metadata: Metadata = {
  title: "Accessibility — Legal | Career OS",
  description: "Career OS Legal accessibility. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
    canonical: "https://career-os.com/legal/accessibility",
  },
};
