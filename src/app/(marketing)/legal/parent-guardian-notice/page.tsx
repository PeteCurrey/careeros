...
export const metadata: Metadata = {
  title: "Parent Guardian Notice — Legal | Career OS",
  description: "Career OS Legal parent Guardian Notice. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
    canonical: "https://career-os.com/legal/parent-guardian-notice",
  },
};
