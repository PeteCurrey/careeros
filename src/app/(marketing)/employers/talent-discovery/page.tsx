...
export const metadata: Metadata = {
  title: "Talent Discovery — Employers | Career OS",
  description: "Career OS Employers talent Discovery. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
    canonical: "https://career-os.com/employers/talent-discovery",
  },
};
