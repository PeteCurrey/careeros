...
export const metadata: Metadata = {
  title: "Internships — Employers | Career OS",
  description: "Career OS Employers internships. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
    canonical: "https://career-os.com/employers/internships",
  },
};
