...
export const metadata: Metadata = {
  title: "Entrepreneurship — Resources | Career OS",
  description: "Career OS Resources entrepreneurship. Verified evidence, persistent career intelligence, and absolute privacy.",
  alternates: {
